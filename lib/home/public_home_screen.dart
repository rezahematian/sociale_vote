...
import '../features/poll/poll_navigation_gate.dart';
...
class _PublicHomeScreenState extends State<PublicHomeScreen>
  ...
  late final Future<List<PollEntity>> _pollsFuture;
  ...
  void initState() {
    ...
    _pollService = AppBootstrap.pollService;
    _pollsFuture = _pollService.getActivePolls();
                  ...
                  final content = SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const _NewsSection(),
                        const SizedBox(height: 80),
                        _PollSection(pollsFuture: _pollsFuture),
...
class _MapSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final height =
        MediaQuery.of(context).size.width < 800 ? 260.0 : 420.0;
...
class _PollSection extends StatelessWidget {
  final Future<List<PollEntity>> pollsFuture;

  const _PollSection({required this.pollsFuture});

  @override
  Widget build(BuildContext context) {
    return FutureBuilder<List<PollEntity>>(
      future: pollsFuture,
