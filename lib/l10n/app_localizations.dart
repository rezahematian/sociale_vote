...
abstract class AppLocalizations {
  ...
  /// Explains that authentication belongs to a person even when representing an organization
  ///
  /// In en, this message translates to:
  /// **'Sign-in always belongs to a person'**
  String get authPersonalAccountOwnershipTitle;

  /// Explains the person-to-organization registration path
  ///
  /// In en, this message translates to:
  ...
  /// Opens the guide for the organization account path
  ///
  /// In en, this message translates to:
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'de', 'en', 'es', 'fa', 'fr', 'it', 'pt', 'ro', 'ru', 'zh'].contains(locale.languageCode);
