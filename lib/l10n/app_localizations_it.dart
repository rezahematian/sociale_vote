...
class AppLocalizationsIt extends AppLocalizations {
  ...
  String get createPollBasicInfoSubtitle =>
      'Definisci i dettagli principali del sondaggio.';
  ...
  String get createPollAllowVoteChangeSubtitle =>
      'Fino alla chiusura del sondaggio.';
  ...
  String get createPollParticipationGeoScopeSubtitle =>
      'Limita questo sondaggio alle persone di uno specifico Paese.';
  ...
  String get createPollCountryFieldHelper =>
      'Questo Paese definirà chi è autorizzato a partecipare a questo sondaggio (funzionalità futura).';
  ...
  String get createPollQuorumSubtitle =>
      'Se impostato, il sondaggio è considerato valido solo se viene raggiunto almeno questo numero di voti. Lascia vuoto per nessun quorum.';
  ...
  String get createPollTimingSubtitle =>
      'Definisci quando il sondaggio deve essere aperto alle votazioni.';
  ...
  String get createPollResultsVisibilityAlwaysLabel =>
      'Sempre visibili (mentre il sondaggio è aperto)';
  ...
  String get createPollResultsVisibilityAfterCloseLabel =>
      'Visibili solo dopo la chiusura del sondaggio';
  ...
  String get searchInputHint =>
      'Cerca account, sondaggi, notizie, pubblicazioni...';
  ...
  String get homeTrendingError =>
      'Impossibile caricare i contenuti di tendenza per quest’area.';

  @override
  String get homeTrendingEmpty =>
      'Nessun contenuto di tendenza per quest’area al momento.';
  ...
  String get homeForYouError =>
      'Impossibile caricare i contenuti Per te per quest’area.';

  @override
  String get homeForYouEmpty =>
      'Nessun contenuto suggerito per te in quest’area al momento.';
  ...
  String get homeSocialErrorSubtitle =>
      'Si è verificato un problema nel caricamento delle discussioni per quest’area.';
  ...
  String get homeSocialEmptySubtitle =>
      'Non ci sono discussioni per quest’area al momento.';
  ...
  String get pollDetail_resultsWhenClosed =>
      'I risultati saranno visibili alla chiusura del sondaggio.';
  ...
  String get pollList_scopeDescriptionGlobal =>
      'Visualizzazione dei sondaggi globali.';

  @override
  String get pollList_scopeDescriptionCountry =>
      'Visualizzazione dei sondaggi per questo paese.';

  @override
  String get pollList_scopeDescriptionCity =>
      'Visualizzazione dei sondaggi per questa città.';
  ...
  String get pollList_emptyMessage =>
      'Nessun sondaggio che corrisponde a questo filtro per quest’area.';
  ...
  String get voteError_unauthorized =>
      'Non sei autorizzato a votare in questo sondaggio.';
  ...
  String get postDetail_shareMessage =>
      'Apri Social Vote per vedere questo post.';
  ...
  String get pollDetail_shareMessage =>
      'Apri Social Vote per vedere e votare questo sondaggio.';
  ...
  String get pollDetail_deletePermissionError =>
      'Puoi eliminare solo i tuoi sondaggi';
  ...
  String get verificationRequestOrganizationSubtitle =>
      'Richiede il nome dell’organizzazione e la revisione';
  ...
  String get onboardingPollDescription =>
      'Vota sui temi che ti interessano e crea Poll per raccogliere l\'opinione della community.';
  ...
  String get onboardingCivicMapDescription =>
      'Esplora sondaggi, post e notizie sulla mappa e scopri cosa succede nei diversi territori.';
  ...
  String get onboardingVerificationDescription =>
      'Alcuni Poll possono richiedere un livello di verifica per proteggere l\'integrità del voto.';
