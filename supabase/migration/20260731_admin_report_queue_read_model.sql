-- Social Vote
-- Admin Center AC8.2: backend-only paginated report queue.

begin;

create or replace function public.admin_get_report_queue(
...
comment on function public.admin_get_report_queue(
  ...
  'Backend-only paginated report queue for Poll, Post, and News moderation.';
